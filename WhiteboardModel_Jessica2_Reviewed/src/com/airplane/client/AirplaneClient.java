...
/*
 * JR: adequate, shows a basic test-drive of a few valid instances.
 * See comments below.
 */
class AirplaneClient {
    ...
    public static void main(String[] args) {
        ...
        //instance1
        // JR: flightNumber is initially set to 8564 via ctor call, but then changed to
        // 57468 via the setter call, not sure why you'd do this.
        Airplane air1 = new Airplane("PDX", "LAX", AirplaneType.BOE_737, 8564);
        ...
        //instance2
        Airplane air2 = new Airplane("MiamiFL", "ChicagoIL", AirplaneType.BOE_767, 2.5, 4564, 20000L);
        air2.ascent();
        air2.cruise();
        air2.descent();
        System.out.println();
        ...
        //instance3
        // JR: see comment above 'instance1' regarding flightNumber
        // JR: no business methods are ever called on 'air3'
        ...
        //instance4
        Airplane air4 = new Airplane("DallasTX", "SanFranciscoCA", AirplaneType.NEXT_GEN_737, 3.0, 3521, 45000L);
        air4.ascent();
        air4.cruise();
        air4.descent();
        System.out.println();
